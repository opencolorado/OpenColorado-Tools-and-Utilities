# ---------------------------------------------------------------------------
#
# opencolorado_bulk_shapefile_download.py
# IMPORTANT: This will download ALL Shapefiles in the Open Colorado database!
#
# ---------------------------------------------------------------------------
...
#    shapefile resources
# 2) Extracts shapefiles and re-project to 2232
#----------------------------------------------------------------------------
...
def main():
    ...
    print "Running a batch download script!"
